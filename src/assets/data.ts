...
export const questions = [
  ...
  "Tío Wilmer, tengo problemas con _____ y quiero tu consejo.",
  ...
  "No sé cómo se peleará la Tercera Guerra Mundial, pero la cuarta se peleará con _____.",
  ...
  "Hoy en El Propio: _____ en la cama.",
  ...
  "Si la virgen fuera andina y San José de los Llanos, el niño Jesús sería_____.",
  "_____? Bájate el app.",
